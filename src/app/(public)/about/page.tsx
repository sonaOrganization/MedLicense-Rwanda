...
export const metadata: Metadata = { title: "About RMDC Exams" };
...
const values = [
  ...
  { icon: Users, title: "Our Team", desc: "Built by experienced medical educators and technologists who have gone through the RMDC process themselves." },
  { icon: Award, title: "Our Results", desc: "98% of students who complete our premium preparation program pass the RMDC exam on their first attempt." },
];
  ...
  return (
    <div className="py-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">About RMDC Exam Prep</h1>
      ...
      <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl p-8 md:p-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">What is the RMDC Exam?</h2>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
          The Rwanda Medical and Dental Council (RMDC) professional examination is a mandatory licensing exam for all healthcare professionals seeking to practice in Rwanda. It covers core medical knowledge, clinical skills, and professional ethics.
        </p>
