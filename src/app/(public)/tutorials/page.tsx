            ...
            <Card key={video.id} hover>
              <CardContent className="p-0">
                <div className="relative aspect-video bg-gray-900 rounded-t-xl overflow-hidden">
                  {video.thumbnail ? (
                    <img src={video.thumbnail} alt={video.titleEn} className="w-full h-full object-cover opacity-80" />
                  ) : (
                ...
                <div className="p-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white text-sm mb-1 line-clamp-2">{video.titleEn}</h3>
                  {video.duration && (
