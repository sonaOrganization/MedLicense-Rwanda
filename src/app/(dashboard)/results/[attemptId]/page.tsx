...
export default async function ResultDetailPage({ params }: Props) {
  ...
  const { data: attempt } = await supabase
    .from("exam_attempts")
    .select("*, exam:exams(title_en, passing_score), answers:attempt_answers(*, question:questions(*, answers(*)), answer:answers(*))")
    .eq("id", attemptId)
  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-gray-900 dark:text-white">{attempt.exam.title_en} — Results</h1>
      </div>
        ...
        <CardContent className="p-8">
          <div className="flex flex-col sm:flex-row items-center gap-8">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-400 mt-1">Passing score: {attempt.exam.passing_score}%</p>
            </div>
        ...
        <CardContent className="p-0">
          <div className="divide-y divide-gray-100 dark:divide-gray-800">
            {attempt.answers.map((aa: {
              ...
              const correct = aa.question.answers.find((a) => a.is_correct);
