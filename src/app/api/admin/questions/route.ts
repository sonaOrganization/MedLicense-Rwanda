...
// POST /api/admin/questions — create one question with answers
export async function POST(req: NextRequest) {
  ...
  const { text_en, explanation_en, difficulty, category_id, answers } = body;
  ...
  const answerRows = answers.map((a: { text_en: string; is_correct: boolean }, i: number) => ({
