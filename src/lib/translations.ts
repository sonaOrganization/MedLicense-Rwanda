...
const T = {
  ...
  session_theory_badge:    { EN: "Unavailable",                                  FR: "Indisponible" },
  ...
  session_practical_badge: { EN: "Available Now",                                 FR: "Disponible" },
  session_practical_toast: { EN: "Let's review some cases!", FR: "Passons en revue quelques cas !" },
  ...
  practical_sub:           { EN: "Hands-on clinical case review — think it through, then check the model answer", FR: "Révision de cas cliniques — réfléchissez, puis consultez la réponse modèle" },
  practical_coming_title:  { EN: "Coming Soon",                                  FR: "Bientôt disponible" },
  practical_coming_desc:   { EN: "We're building practical case content for your license category. You'll be notified as soon as it's ready.", FR: "Nous préparons le contenu des cas pratiques pour votre catégorie de licence. Vous serez averti dès qu'il sera prêt." },
  practical_cta_theory:    { EN: "Practice Theory Sessions Meanwhile",           FR: "Pratiquer les sessions théoriques en attendant" },
  practical_list_cases:     { EN: "cases",                                      FR: "cas" },
  practical_list_questions: { EN: "questions",                                  FR: "questions" },
  practical_list_review:    { EN: "Review Case",                                FR: "Réviser le cas" },
  practical_list_resume:    { EN: "Resume Review",                              FR: "Reprendre la révision" },
  practical_list_retake:    { EN: "Review Again",                               FR: "Réviser à nouveau" },
  practical_list_free:      { EN: "Free",                                       FR: "Gratuit" },
  practical_list_upgrade:   { EN: "Upgrade to Unlock",                          FR: "Mettre à niveau" },
  practical_list_last_score:{ EN: "Last self-graded accuracy",                  FR: "Dernière précision auto-évaluée" },
  practical_stats_reviewed: { EN: "Cases Reviewed",                             FR: "Cas révisés" },
  practical_stats_accuracy: { EN: "Self-Graded Accuracy",                       FR: "Précision auto-évaluée" },
  practical_stats_streak:   { EN: "Review Streak",                             FR: "Série de révisions" },
  practical_exams_title:    { EN: "Browse Cases",                              FR: "Parcourir les cas" },
  practical_exams_sub:      { EN: "Choose a case to start reviewing",          FR: "Choisissez un cas à réviser" },
  practical_dash_badge:     { EN: "Practical Exams Dashboard",                 FR: "Tableau de bord — Sessions pratiques" },
  practical_dash_browse:    { EN: "Browse Cases",                              FR: "Parcourir les cas" },
  practical_dash_resume:    { EN: "Resume Case",                               FR: "Reprendre le cas" },
  practical_dash_unlock:    { EN: "Unlock Full Access",                        FR: "Accès complet" },
  practical_dash_available: { EN: "Cases Available",                           FR: "Cas disponibles" },
  practical_dash_recent:    { EN: "Recent Case Reviews",                       FR: "Révisions récentes" },
  practical_dash_recent_sub:{ EN: "Your last completed case reviews",          FR: "Vos dernières révisions terminées" },
  practical_dash_view_all:  { EN: "View all in Browse Cases",                  FR: "Voir tout dans Parcourir les cas" },
  practical_dash_empty:     { EN: "No cases reviewed yet",                     FR: "Aucun cas révisé pour l'instant" },
  practical_dash_empty_sub:{ EN: "Start your first case review to track your progress here.", FR: "Commencez votre première révision de cas pour suivre vos progrès ici." },
  practical_dash_resume_banner_title: { EN: "You have a case in progress",     FR: "Vous avez un cas en cours" },
  practical_dash_resume_banner_cta:   { EN: "Continue where you left off",     FR: "Continuer où vous vous êtes arrêté" },
  practical_engine_case_progress:     { EN: "Question {n} of {total}",                FR: "Question {n} sur {total}" },
  practical_engine_start_thinking:    { EN: "Start Thinking",                        FR: "Commencer à réfléchir" },
  practical_engine_thinking_hint:     { EN: "Take your time…",                       FR: "Prenez votre temps…" },
  practical_engine_review_answer:     { EN: "Review Answer",                        FR: "Voir la réponse" },
  practical_engine_model_answer_label:{ EN: "Model Answer",                         FR: "Réponse modèle" },
  practical_engine_mark_correct:      { EN: "Correct",                              FR: "Correct" },
  practical_engine_mark_incorrect:    { EN: "Incorrect",                            FR: "Incorrect" },
  practical_engine_next_question:     { EN: "Next Question",                       FR: "Question suivante" },
  practical_engine_finish:            { EN: "Finish Case Review",                  FR: "Terminer la révision" },
  practical_engine_submitting:        { EN: "Submitting…",                         FR: "Envoi en cours…" },
  practical_results_title:            { EN: "Case Review Results",                 FR: "Résultats de la révision" },
  practical_results_accuracy:         { EN: "Self-graded accuracy",                FR: "Précision auto-évaluée" },
  practical_results_reviewed:         { EN: "Questions reviewed",                  FR: "Questions révisées" },
  practical_results_correct:          { EN: "Correct",                             FR: "Correctes" },
  practical_results_incorrect:        { EN: "Incorrect",                           FR: "Incorrectes" },
  practical_results_retake:           { EN: "Review Again",                        FR: "Réviser à nouveau" },
  practical_results_back:             { EN: "Back to Practical Sessions",          FR: "Retour aux sessions pratiques" },
  practical_results_your_mark:        { EN: "Your self-mark:",                     FR: "Votre auto-évaluation :" },
