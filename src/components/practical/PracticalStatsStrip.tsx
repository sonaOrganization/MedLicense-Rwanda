...
export function StatTile({ icon: Icon, label, value }: { icon: typeof ClipboardCheck; label: string; value: string | number }) {
  return (
    <div
      className={cn(
...
/** Renders just the tiles (no grid wrapper) so callers can compose them alongside other tiles in one grid. */
