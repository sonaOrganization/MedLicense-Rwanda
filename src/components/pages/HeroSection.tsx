        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            <p className="text-[17px] text-gray-400 leading-relaxed mb-8 max-w-lg">
              Rwanda's most comprehensive medical licensing exam preparation platform. Authentic exam simulations, clinician-authored content, and evidence-based analytics — designed for aspiring medical professionals.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-10">
              <Link href="/register">
                <Button
                  size="lg"
                  className="h-12 px-7 text-[15px] font-semibold bg-blue-700 hover:bg-blue-600 text-white shadow-xl shadow-blue-900/50 w-full sm:w-auto gap-2"
                >
                  Start Free Trial
